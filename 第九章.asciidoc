...
區塊的主要標識符是它的加密雜湊值，這是一種數字指紋，通過SHA256演算法將區塊頭兩次雜湊獲得。得到的32位元組雜湊被稱為 _block hash_ ，更準確地說是 _block header hash_，因為只有區塊頭用於計算。例如 +000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f+ 是第一個區塊的雜湊值，
